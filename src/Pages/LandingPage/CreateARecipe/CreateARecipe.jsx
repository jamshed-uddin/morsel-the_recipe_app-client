...
const CreateARecipe = () => {
  ...
  return (
    <div className="text-colorOne my-6 h-[28rem] rounded-2xl md:rounded-none   md:h-[calc(100vh-5rem)] w-full overflow-hidden md:flex items-center gap-8 relative">
      ...
      <div className="md:w-1/2 absolute md:static bottom-1 left-2">
        <h1 className="text-6xl md:text-8xl text-bgColor md:text-colorOne tracking-tight">
